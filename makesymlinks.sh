...
files="zshenv zshrc aliases gitconfig gitignore_global functions alacritty.yml tmux.conf"    # list of files/folders to symlink in homedir TODO: Populate this list automatically
